...
const DndDemo = () => {
    ...
    const _sourceItems: DragItem[] = [
        { id: "1", label: "Red Item", color: "#e74c3c" },
        { id: "2", label: "Green Item", color: "#2ecc71" },
        { id: "3", label: "Blue Item", color: "#3498db" },
        { id: "4", label: "Yellow Item", color: "#f1c40f" },
    ];

    const _addToHistory = (message: string) => {
        setDropHistory((prev) => [...prev.slice(-4), message]);
    };

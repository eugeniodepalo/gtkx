...
export type GtkxConfig = {
     ...
     *
     * Used by `gtkx dev` and `gtkx build` to register the GTK application
     * at runtime. If omitted, falls back to a value exported from the
     * application entry module, then to `"org.gtkx.dev"`.
     */
    appId?: string;
};

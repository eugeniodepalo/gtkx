...
describe("GirClass / implementsInterface", () => {
...
describe("GirClass / getAllImplementedInterfaces", () => {
...
describe("GirClass / lookup helpers", () => {
    const ctx = createRepo();
...
describe("GirClass / inheritance accumulators", () => {
...
describe("GirClass / find helpers walk up the inheritance chain", () => {
    function buildHierarchy() {
        const ctx = createRepo();
        const parentMethod = makeMethod("show");
        const parentProperty = makeProperty("visible");
...
describe("GirClass / classification helpers", () => {
...
describe("GirClass / getDirectSubclasses", () => {
...
describe("GirClass / getInheritanceChain", () => {
...
describe("GirClass / ignored field arguments", () => {

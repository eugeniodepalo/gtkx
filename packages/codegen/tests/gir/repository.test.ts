...
describe("GirRepository / fromXml", () => {
...
describe("GirRepository / getNamespace", () => {
...
describe("GirRepository / resolveClass", () => {
...
describe("GirRepository / resolveInterface", () => {
...
describe("GirRepository / resolveRecord", () => {
...
describe("GirRepository / resolveEnum", () => {
...
describe("GirRepository / resolveFlags", () => {
...
describe("GirRepository / resolveCallback", () => {
...
describe("GirRepository / resolveConstant", () => {
...
describe("GirRepository / resolveFunction", () => {
...
describe("GirRepository / getTypeKind", () => {
...
describe("GirRepository / isPrimitive", () => {
...
describe("GirRepository / isGObject", () => {
...
describe("GirRepository / isBoxed", () => {
...
describe("GirRepository / findClasses", () => {
...
describe("GirRepository / findInterfaces", () => {
...
describe("GirRepository / findRecords", () => {
...
describe("GirRepository / getAllNamespaces", () => {
...
describe("GirRepository / class traversal", () => {

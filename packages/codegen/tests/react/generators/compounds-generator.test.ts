...
describe("CompoundsGenerator / generate (1)", () => {
    ...
    it("emits nothing when widgets are filtered out by namespace", () => {
        const code = generate([createCodegenWidgetMeta({ jsxName: "GtkWindow", className: "Window" })], [], ["Adw"]);
        expect(code).toBe("");
    });
...
describe("CompoundsGenerator / generate (2)", () => {
...
describe("CompoundsGenerator / generate (3)", () => {
...
describe("CompoundsGenerator / generate (4)", () => {
...
describe("CompoundsGenerator / getCompoundJsxNames", () => {

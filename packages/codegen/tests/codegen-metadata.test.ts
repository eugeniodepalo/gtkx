...
describe("CodegenMetadata / addWidgetMeta / getAllWidgetMeta", () => {
...
describe("CodegenMetadata / metadata structure", () => {
...
describe("CodegenMetadata / multiple metadata instances", () => {
    it("are independent", () => {

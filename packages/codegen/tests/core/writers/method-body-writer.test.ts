...
import {
    ...
    MethodBodyWriter,
} from "../../../src/core/writers/method-body-writer.js";
import {
...
describe("MethodBodyWriter - extended coverage", () => {
    describe("setSelfNames", () => {
    ...
    describe("selectConstructors - unsupported", () => {
    ...
    describe("computeReturnTypeString", () => {
    ...
    describe("buildStaticFunctionStructure", () => {
    ...
    describe("buildClassStructStaticStructure", () => {
    ...
    describe("buildStubStructure", () => {
        ...
        it("marks static stubs as static", () => {
            ...
            const structure = writer.buildStubStructure("doThing", "Gtk.doThing", undefined, "Gtk", true);

            expect(structure.isStatic).toBe(true);
        });
    });

    describe("writeMethodBody - out parameters and tuple returns", () => {
    ...
    describe("writeMethodBody - return wrapping variants", () => {
    ...
    describe("writeFunctionBody - own class returns", () => {
    ...
    describe("buildAsyncCallableStructure", () => {
        ...
        it("builds a Promise-returning wrapper for a GIO async pair", () => {
            ...
            const asyncCallable = createNormalizedMethod({
                name: "load_async",
            ...
            const finishCallable = createNormalizedMethod({
                name: "load_finish",
    ...
    describe("writeHiddenOutDeclarationFor", () => {
    ...
    describe("writeCallbackWrapperDeclarations", () => {
    ...
    describe("writeMethodBody - callback wrapper generation", () => {
    ...
    describe("writeMethodBody - tuple body with wrapped returns", () => {
    ...
    describe("writeMethodBody - array of interfaces", () => {
    ...
    describe("writeMethodBody - nullable out parameters", () => {
    ...
    describe("writeMethodBody - result name collision", () => {
    ...
    describe("writeMethodBody - inout boxed parameter", () => {
    ...
    describe("writeFactoryMethodBody - hidden outs", () => {

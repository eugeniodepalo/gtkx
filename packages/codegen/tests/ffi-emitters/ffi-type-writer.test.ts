...
describe("FfiTypeWriter / constructor", () => {
...
describe("FfiTypeWriter / createGErrorRefTypeDescriptor", () => {
...
describe("FfiTypeWriter / createSelfTypeDescriptor (1)", () => {
...
describe("FfiTypeWriter / createSelfTypeDescriptor (2)", () => {
...
describe("FfiTypeWriter / setSharedLibrary", () => {

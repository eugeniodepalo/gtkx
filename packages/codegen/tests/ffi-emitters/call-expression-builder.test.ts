...
import { CallExpressionBuilder, type CallExpressionOptions } from "../../src/ffi-emitters/call-expression-builder.js";
...
describe("CallExpressionBuilder / constructor", () => {
...
describe("CallExpressionBuilder / toWriter (1)", () => {
...
describe("CallExpressionBuilder / toWriter (2)", () => {
...
describe("CallExpressionBuilder / toWriter (3)", () => {
...
describe("CallExpressionBuilder / toWriter (4)", () => {
...
describe("CallExpressionBuilder / buildValueExpression (1)", () => {
...
describe("CallExpressionBuilder / buildValueExpression (2)", () => {
...
describe("CallExpressionBuilder / buildValueExpression (3)", () => {
...
describe("CallExpressionBuilder / descriptor type rendering", () => {
...
describe("CallExpressionBuilder / registry-driven hoisting (1)", () => {
...
describe("CallExpressionBuilder / registry-driven hoisting (2)", () => {
...
describe("CallExpressionBuilder / registry-driven hoisting (3)", () => {
...
describe("CallExpressionBuilder / registry-driven hoisting (4)", () => {
...
describe("CallExpressionBuilder / complex call expressions (1)", () => {
...
describe("CallExpressionBuilder / complex call expressions (2)", () => {

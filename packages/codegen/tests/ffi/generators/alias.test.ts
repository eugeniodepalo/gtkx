...
describe("AliasGenerator / constructor", () => {
...
describe("AliasGenerator / addAliases (1)", () => {
...
describe("AliasGenerator / addAliases (2)", () => {
...
describe("AliasGenerator / addAliases (3)", () => {
...
describe("AliasGenerator / hasOverrides", () => {

...
describe("EnumGenerator / constructor", () => {
...
describe("EnumGenerator / addEnums (1)", () => {
...
describe("EnumGenerator / addEnums (2)", () => {
...
describe("EnumGenerator / addEnums (3)", () => {
...
describe("EnumGenerator / addEnums (4)", () => {
...
describe("EnumGenerator / addEnums (5)", () => {
...
describe("EnumGenerator / deduplication", () => {

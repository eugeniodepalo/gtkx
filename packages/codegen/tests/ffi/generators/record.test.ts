...
describe("RecordGenerator / constructor", () => {
...
describe("RecordGenerator / generateToSourceFile (1)", () => {
...
describe("RecordGenerator / generateToSourceFile (2)", () => {
...
describe("RecordGenerator / generateToSourceFile (3)", () => {
...
describe("RecordGenerator / field generation (1)", () => {
...
describe("RecordGenerator / field generation (2)", () => {
...
describe("RecordGenerator / constructor generation (1)", () => {
...
describe("RecordGenerator / constructor generation (2)", () => {
...
describe("RecordGenerator / method generation (1)", () => {
...
describe("RecordGenerator / method generation (2)", () => {
...
describe("RecordGenerator / init interface generation (1)", () => {
...
describe("RecordGenerator / init interface generation (2)", () => {
...
describe("RecordGenerator / init interface generation (3)", () => {
...
describe("RecordGenerator / init interface generation (4)", () => {
...
describe("RecordGenerator / context updates (1)", () => {
...
describe("RecordGenerator / context updates (2)", () => {
...
describe("RecordGenerator / JSDoc generation", () => {
...
describe("RecordGenerator / construction metadata (1)", () => {
...
describe("RecordGenerator / construction metadata (2)", () => {
...
describe("RecordGenerator / union layout", () => {
...
describe("RecordGenerator / bitfield fields (1)", () => {
...
describe("RecordGenerator / bitfield fields (2)", () => {
...
describe("RecordGenerator / bitfield fields (3)", () => {
...
describe("RecordGenerator / array fields (1)", () => {
...
describe("RecordGenerator / array fields (2)", () => {
...
describe("RecordGenerator / array fields (3)", () => {
...
describe("RecordGenerator / array fields (4)", () => {
...
describe("RecordGenerator / nested struct and callback fields (1)", () => {
...
describe("RecordGenerator / nested struct and callback fields (2)", () => {
...
describe("RecordGenerator / nested struct and callback fields (3)", () => {
    it("exposes a callback struct field as a raw pointer slot", () => {
        const { generator, file } = createTestSetupWithRepo((ns) => {
            ns.callbacks.set("DrawFunc", createNormalizedCallback({ name: "DrawFunc", qualifiedName: "Gdk.DrawFunc" }));
        });
        const record = createNormalizedRecord({
            name: "Painter",
            fields: [
...
describe("RecordGenerator / nested struct and callback fields (4)", () => {
...
describe("RecordGenerator / nested struct and callback fields (5)", () => {
...
describe("RecordGenerator / nested struct and callback fields (6)", () => {
...
describe("RecordGenerator / nested struct and callback fields (7)", () => {
...
describe("RecordGenerator / filtering and edge cases (1)", () => {
...
describe("RecordGenerator / filtering and edge cases (2)", () => {
...
describe("RecordGenerator / filtering and edge cases (3)", () => {
...
describe("RecordGenerator / filtering and edge cases (4)", () => {
...
describe("RecordGenerator / filtering and edge cases (5)", () => {

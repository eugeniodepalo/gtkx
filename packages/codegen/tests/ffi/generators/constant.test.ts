...
describe("ConstantGenerator / constructor", () => {
...
describe("ConstantGenerator / addConstants (1)", () => {
...
describe("ConstantGenerator / addConstants (2)", () => {
...
describe("ConstantGenerator / addConstants (3)", () => {
...
describe("ConstantGenerator / deduplication (1)", () => {
...
describe("ConstantGenerator / deduplication (2)", () => {
...
describe("ConstantGenerator / edge cases (1)", () => {
...
describe("ConstantGenerator / edge cases (2)", () => {

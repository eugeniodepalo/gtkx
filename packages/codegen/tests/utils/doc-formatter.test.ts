...
import { buildJsDocStructure, sanitizeDoc } from "../../src/utils/doc-formatter.js";

describe("sanitizeDoc / basic text", () => {
...
describe("sanitizeDoc / GIR link conversion (1)", () => {
    it("converts class links to GTK docs URLs", () => {
        expect(sanitizeDoc("[class@Gtk.Button]")).toBe("[`Gtk.Button`](https://docs.gtk.org/gtk4/class.Button.html)");
    });
...
describe("sanitizeDoc / GIR link conversion (2)", () => {
...
describe("sanitizeDoc / link style options", () => {
...
describe("sanitizeDoc / @ annotation conversion", () => {
...
describe("sanitizeDoc / HTML link stripping", () => {
...
describe("sanitizeDoc / XML tag escaping", () => {
...
describe("sanitizeDoc / namespace URL resolution", () => {

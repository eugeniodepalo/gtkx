...
import { parseParentReference } from "../../src/utils/parent-reference.js";
import { qualifiedName } from "../fixtures/gir-fixtures.js";

describe("parseParentReference / with no parent", () => {
...
describe("parseParentReference / with same-namespace parent", () => {
...
describe("parseParentReference / with cross-namespace parent", () => {
...
describe("parseParentReference / special cases", () => {
...
describe("parseParentReference / with string parent", () => {
